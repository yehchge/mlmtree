...
class mlmBinary{
    ...
    protected $dbUser = 'robot';
    
    protected $dbPass = 'robot';
    ...
    */
    ...
    public function dbConnect(){
        ...
        if( mysqli_connect_errno() ){
            ...
            $encode = "utf8";
            $this->dbQuery("SET character_set_client = $encode");
            $this->dbQuery("SET character_set_results = $encode");
            $this->dbQuery("SET character_set_connection = $encode");
